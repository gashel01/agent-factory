...
import type { ReviewComment, TreeNode } from "./repo-modal.js";
...
export type { TreeNode, ReviewComment };
export { buildFileTree, sortedEntries, TreeFolder, FileTree, CodeLine, CodeBlock, RepoModal } from "./repo-modal.js";
